...
class SummaryService:
    ...
    def get_summary_yearly(year: int, user_id: int):
        incomes = IncomeService.get_incomes_by_year(year=year, user_id=user_id)
        expenses = ExpenseService.get_expense_by_year(year=year, user_id=user_id)
        savings = SavingValueService.get_unused_by_year(year=year, user_id=user_id)
